      ...
      <div className="bg-white shadow-xl rounded-lg w-full max-w-md">
        ...
        <div className="p-4 sm:p-6">
          {step === 1 && (<div><h3 className="text-lg sm:text-xl font-semibold text-gray-700 mb-3">Gather Necessary Documents</h3><p className="text-gray-600 text-sm mb-4">Before filing...</p>
              ...
              <div className="bg-gray-200 h-48 rounded-lg flex items-center justify-center mb-6 overflow-hidden"><img src="https://miro.medium.com/v2/resize:fit:1400/1*8ZhgsyCNQRDaKEB7Rk_Udw.jpeg" alt="Abstract City Map" className="rounded-md object-cover w-full h-full" onError={(e) => { e.target.onerror = null; e.target.src="https://placehold.co/300x150/007bff/ffffff?text=Map"; }}/></div></div>)}
